...
# OCR Setup
# -----------------------------
reader = easyocr.Reader(['en', 'ur', 'ar'], gpu=False)  # Arabic model also helps with Sindhi

# For Linux/Streamlit Cloud, use system tesseract
# No need for Windows paths
# Ensure Urdu traineddata is available on Streamlit Cloud
# Use lang='eng+urd' for fallback
